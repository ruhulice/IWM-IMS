                            ...
                            <div class="row modify_section">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold">Subcategory <span
                                                        style="color: red">*</span></label>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="font-weight-bold">CS Date <span
                                                        style="color: red">*</span></label>
                                                <input type="date" class="form-control" id="csdate" name="csdate"
                            ...
                            <div class="row modify_section">
                                ...
                                <div class="col-md-12">
                                    <table id="MemTable" class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <th>Vendor <span style="color: red">*</span></th>
...
@section('js_after')
    ...
    <script>
        ...
        // function getEquipmentbyCategory() {
        ...
        //                     `<option value="${id}">${subcategoryname}</option>`);
        //             });
        //             // let $subcategory = $('#subcategoryid' + rowId);
        //             // $subcategory.empty().append('<option value="">Select One</option>');
        ...
        $('#addRow').click(function() {
            ...
            <tr data-rowid="${count_row}">
                <td>
                    <select class="form-control" id="vendorid${count_row}" name="vendorid[]"  required>
                        <option value="">Select One</option>
                ...
                <td> <input type="file" name="pdffile[]" class="form-control-file" accept="application/pdf"></td>
