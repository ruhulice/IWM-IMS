...
<body>
        ...
        <div class="row justify-content-between">
            ...
            <div class="col-sx-4 col-sm-3 col-md-12 offset-lg-1 col-lg-2  order-md-last brand-title">
                <div class="row" style="    display: flex;align-content: center;justify-content: center;">
                    ...
                    <a class="btn btn-info pull-right landing-text-bn" style="margin-top:5px;"
                        href="/dashboard">লগইন</a>
                    <a class="btn btn-info pull-right landing-text-en" style="margin-top:5px;"
 ...
 <li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
    ...
    <section class="hero-wrap"
        style="background-image: url('{{ asset('assets/landing/images/iwm.jpg') }}'); background-size: cover; background-position: bottom bottom; height: 100vh;"
        data-stellar-background-ratio="0.5">
        <div class="overlay"></div>
        <div class="container-fluid">
            <div class="row no-gutters slider-text">
                <div class="col-ms-12 col-md-12 col-lg-10 offset-lg-1  ftco-animate d-flex align-items-end"
                    style="margin-bottom:10px;">
                    <div class="text w-100 text-white-backgroud-n">
                        <p class="mb-0 landing-text-bn" style="text-align: justify;">
                            IWM-IMS (Integrated Management System) is an internal web-based software platform developed
                            by the Institute of Water Modelling (IWM) to centralize and streamline multiple
                            organizational workflows. It serves as a unified digital solution for managing key
                            operational modules such as IT equipment requisition, vehicle requisition, and store and
                            inventory management, with potential to expand into other areas like HR, administration, and
                            finance.
                        </p>
                ...
                <div class="col-ms-12 col-md-12 col-lg-8 offset-lg-1 ftco-animate d-flex"
                    style="margin-bottom:15px; padding-left: 0px; margin-top: 5px; padding-right: 0px;">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <p class="mb-0" style="color: rgba(255,255,255,.5); text-align: left;">
                            <a href="https://www.iwmbd.org/" target="_blank">Copyright &copy;
                                <script>
                                    document.write(new Date().getFullYear());
                                </script> Institute of Water Modelling (IWM). All rights reserved.
                            </a>
                        </p>
                    </div>
                    <div class="col-sm-12 col-md-6">
